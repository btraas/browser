...
public abstract class Messaging {
    ...
    private static final String TAG = Messaging.class.getName();
        ...
        try {
            ...
            if(data.has("alert")) {
                ...
                if(data.has("link")) {
                    ...
                    dialogAction = new OnClickListener() {
                        @Override
    ...
    public static void show(Activity activity, Snackbar snackbar) {
        ...
        Log.d(TAG, "Showing message: "
                +((TextView)snackbar.getView().findViewById(android.support.design.R.id.snackbar_text)).getText());
        hideInput(activity);
        snackbar.show();
    }
    ...
    public static void showSuccess(Activity activity, String msg, int length) {
        ...
        show(activity, snackbar, ContextCompat.getColor(activity, R.color.colorPrimaryDark));
    }
